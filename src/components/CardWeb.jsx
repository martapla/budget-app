...
return (
    ...
    <>
      <div className="w-full md:w-5/6 mx-auto bg-blue-50 border border-1 border-[#3498db] rounded-xl shadow-xl overflow-hidden  mt-3 md:mt-5 flex align-baseline justify-around flex flex-column flex-wrap ">
